			...
			<div class="dashboard_section">
				<div class="dashboard_details">
					<div class="user_img theme-img">
						<img src="<?php echo get_avatar_url(get_the_author_meta('ID')); ?>" alt="user-icon">
					</div>
					...
					<div class="dashboard_inner">
						<div class="dashborad_card">
							...
							<div class="card_content">
								...
								<a href="<?php echo "http://" . $_SERVER['SERVER_NAME'] ."/wordpress/greet-and-green/liste-de-souhaits/";?>" class="theme-btn-secound" title="Consulter La wishlist">Consulter La wishlist</a>
							</div>
						</div>
					</div>
					<div class="dashboard_inner">
						<div class="dashborad_card">
							...
							<div class="card_content">
								...
								<a href="<?php echo "http://" . $_SERVER['SERVER_NAME'] ."/wordpress/greet-and-green/mon-compte/cart-product/";?>" class="theme-btn-secound" title="Voir Les Projets En Cours">Voir Les Projets En Cours</a>
							</div>
						</div>
					</div>
					<div class="dashboard_inner">
