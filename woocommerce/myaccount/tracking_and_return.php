               ...
               <div class="dashboard-table">
                  ...
                  <div class="dashboard-table-contain">
                     ...
                     <form class="table-form table-invites">
                        <table class="table table-main tracking-table" id="order_tracking_table_container">
                           <thead class="table-thead">
                              <tr>
                                 <th class="table-checkbox">
                                    <div class="table-checkbox-cover">
                                       <!-- <input type="checkbox" onclick="invois_checked_all_users()" id="selectall"> -->
                                       <input type="checkbox" onclick="tracking_and_return_checked_all_users()" id="selectall">
                                    </div>
                                 </th>
                  ...
                  <div class="dashboard-table-footer">
                     <div class="table-footer-cover">
                        ...
                        <div class="table-footer-icon">
                           <a onclick="export_table_details()" class="download-icon">download</a>
...
<main class="main-cover address_book_popup" style="display:none1;">
   <!-- client address book -->
   <section class="client-address-main">
      <div class="container">
         ...
         <div class="add-contact-cover">
            ...
            <!-- <form action="" method="POST" id="form_import" name="form_import"> -->
            <!-- <input type="file" name="upload_data"> -->
            <!-- <button class="upload" type="submit" name="btn_upload">Upload</button> -->
            <!-- <input class="button-primary" type="button" name="btn_upload" id="btn_upload_1" value="Start importing"/>                                     -->
            <!-- </form> -->
