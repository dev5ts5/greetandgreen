...
$get_json_canvas_data = $conn->prepare("select * from gragr_fpd_views where ID = 118");
...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( '', $product ); ?>>
	<div class="product_top_bar">
		...
		<div class="top_bar_second topbar_child">
			<ul class="product_top_menu">
				<li id="animation_header_carte" class="carte_menu child_menu active" onclick="opennext_tab(event, 'carte')" data-name="carte">
					<span class="carte image_icon">carte</span>
					<span class="menu_text">carte</span>
				</li>

				<li id="animation_header_envelope" class="enveloppe_menu test123 child_menu" onclick="opennext_tab(event, 'enveloppe')" data-name="enveloppe">
					<span class="enveloppe image_icon">enveloppe</span>
					<span class="menu_text">enveloppe</span>
				</li>

				<li id="animation_header_animation" class="animation_menu child_menu" onclick="opennext_tab(event, 'animation')" data-name="animation">
	...
	<div id="carte" class="tabcontent tab123">
	<?php
	/**
