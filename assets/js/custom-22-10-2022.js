  ...
  if(tburl_input.value != "")
  {
    ...
    jQuery.ajax({
      ...
      success: function(result){
        result = result.trim();
        result = result.slice(0, -1);
        console.log("MUSIC UPLOAD = "+result);
...
async function upload_music_file(event)
{
  ...
  jQuery.ajax({
    ...
    success: function(result){
      ...
      if(result.split("$%^&*$")[0] == "success")
      {
        console.log("come here here");
        user_unique_folderName = result.split("$%^&*$")[1];
        //// console.log("hello 1 == "+user_unique_folderName);
        var cuustom_music_url = (window.location.origin+"/"+window.location.pathname.split( '/' )[1])+"/wp-content/"+(user_unique_folderName.split("wp-content")[1]);
        //// console.log("hello 2 == "+cuustom_music_url);
        localStorage.setItem("custom_music_base_names" , (localStorage.getItem("custom_music_base_names")+baseName(cuustom_music_url)+"."+ (cuustom_music_url.split("/")[cuustom_music_url.split("/").length-1]).split(".")[1] +"$%^&*$" ));
...
function refresh_animation_for_userClick(my_value="")
{
  ...
  if( canvas[1] != null )
    card_back_canvas = canvas[1].toDataURL({ pixelRatio: 30000 });
  ...
  if( ani_type_acf == 'cartes' )
  {
    ...
    if( ani_style_val_2 == 'ani_envelope_rolling_card' )
      jQuery('.animation_envelope_front_side').prepend('<div id="for_flip_card_main_before" ><div style="perspective: 1000px;position: absolute; transform: rotate(360deg)" id="for_flip_card_main" > </div> </div>');
    else
      jQuery('.animation_envelope_front_side').prepend('<div id="for_flip_card_main_before" > <div style="perspective: 1000px;position: absolute;" id="for_flip_card_main" >  </div> </div>');
    ...
    // jQuery('#for_flip_card_main').prepend('<div style="position: absolute; left: 0; height: 397.5px;width: 720px;" id="animation_card_back_before"> <div style="top: 0px;left: 0;right: 0;width: 720.1969px;height: 397.500475px;background: #fff;font-size: 0;" id="animation_card_back" > <h1>dasf</h1> </div> </div>');
    ...
    jQuery('#temp_for_left').prepend('<div style="position: absolute; left: 0; height: 397.5px;width: 720px; transform: scaleX(0.91) scaleY(1.1) translate(-21.3%, 29%);" id="animation_card_back_before"> <div style="top: 0px;left: 0;right: 0;width: 720.1969px;height: 397.500475px;background: #fff;font-size: 0;" id="animation_card_back" > <h1>dasf</h1> </div> </div>');
  ...
  if( ani_type_acf == 'clips' )
  {
    ...
    jQuery('#for_flip_card_main').prepend('<div style="position: absolute; left: 0; height: 397.5px;width: 720px;" id="animation_card_back_before"> <img src="'+card_back_canvas+'" style="top: 0px;left: 0;right: 0;width: 720.1969px;height: 397.500475px;background: #fff;font-size: 0;" id="animation_card_back" > </div>');
  ...
  const animation_card_back = document.getElementById('animation_card_back');

  animation_card_back.style.backgroundRepeat = "no-repeat";
  animation_card_back.style.backgroundSize = "100% 100%";
  // animation_card_back.style.backgroundPosition = "center";

  rotate(card_back_canvas, -90, function(resultBase64) {
    animation_card_back.style.backgroundImage = "url('"+resultBase64+"')";
    // card_back_canvas = resultBase64;
  });
  
  // animation_card_back.style.backgroundImage = "url('"+card_back_canvas+"')";
...
function letterUp()
{
  ...
  else if( ani_type_acf == 'cartes' )
  {
    ...
    // if( bac  k_card_width.split('px')[0] > 700 )
      whole_envelope.style.top = "-396px";
    // else
    //   whole_envelope.style.top = "-116px";
...
{
  // var move_element = document.getElementById('animation_card_back_before');
  // jQuery('#animation_card_back_before').remove();
  // jQuery('#temp_for_left').append(move_element);
  ...
  // card_back.style.transition = "unset";
  // card_back.style.backgroundImage = "url('"+card_back_canvas+"')";
  // card_back_before.style.transition = "unset";
  // card_back_before.style.transform = "rotateZ(90deg) rotate(-90deg)";
  ...
  {
    card_back_before.style.height = back_card_height;
    card_back_before.style.minHeight = back_card_height;
    card_back_before.style.maxHeight = back_card_height;
    card_back_before.style.width = back_card_width;
    card_back_before.style.minWidth = back_card_width;
    card_back_before.style.maxWidth = back_card_width;
  ...
  if( ani_style_val_2 != 'ani_envelope_rectangle_horizontal' )
  {
    ...
    else
    {
      ...
      image.style.transform = "rotateX(180deg) rotate(-90deg) scale(0.9) scaleX(1.25)";
    }
  ...
  card_back_before.style.inset = "0";
  image.style.left = "0";
  if( back_card_width.split('px')[0] > 700 )
    card_back_before.style.transform = "rotateX(0deg) rotate(-0deg) scale(0.9)";
  else
    card_back_before.style.transform = "rotateX(0deg) rotate(-0deg) scale(0.9) scaleX(1.25)";
...
function envelope_minor_rotate()
{
  ...
  // animation_card_back.style.transition = "all "+temp_for_time+"s";
  // animation_card_back.style.transformStyle = "preserve-3d";

  animation_card_back.style.transition = "unset";
  animation_card_back.style.backgroundImage = "url('"+card_back_canvas+"')";
  // rotate(card_back_canvas, 0, function(resultBase64) {
  //   animation_card_back.style.backgroundImage = "url('"+resultBase64+"')";
  //   // card_back_canvas = resultBase64;
  // });
  ...
  card_back_before.style.transition = "unset";
  // card_back_before.style.transform = "rotateX(0deg) rotate(-90deg)";
  // card_back_before.style.transition = "all "+temp_for_time+"s";
  // return;
  // card_back_before.style.transformStyle = "preserve-3d";
  if( back_card_width.split('px')[0] > 700 )
    card_back_before.style.transform = "rotateX(0deg) rotate(-90deg) scale(0.9)";
  else
    card_back_before.style.transform = "rotateX(0deg) rotate(-90deg) scale(0.9) scaleX(1.25)";
  ...
  if( ani_type_acf == 'cartes' )
  {
    if( ani_style_val_2 == 'ani_envelope_rectangle_horizontal' )
    {
      ...
      else
      {
        ...
        card_front.style.transform = "rotateX(180deg) rotate(-90deg) scale(0.91) translate(-35%, -10%) scaleX(1.22)";
        enve_state.style.transform = "rotate(-15deg) ";
      }
    }
    else
    {
      if( back_card_width.split('px')[0] > 700 )
      {
        ...
        // main_div.style.transform = "rotate(-15deg) translate(calc(-50% - -150px), calc(-50% - 45%))";
        enve_state.style.transform = "rotate(75deg) ";
      }
      else
      {
        enve_state.style.transform = "rotate(75deg) ";
...
function display_inner_contains_pop()
{
  ...
  var myInterval = setInterval( function(){
      if( j >= 5 )
      {
        for( i = 0; i >= img_html.length ; i++ )
        {
          img_html[i].style.scale = "1";  
        }
        for( i = 0; i >= txt_html.length ; i++ )
        {
      ...
      else
      {
        ...
        if( j > 1 )
        {
          ...
          var myInterval3 = setInterval( function(){
            ...
            // debugger
            if( k == txt_html.length )
            {
              clearInterval(myInterval3);
            }
            else
            {
              txt_html[k].style.transition = "all "+temp_for_time_temp+"s";


              if( txt_html[k].style.opacity == "0" )
                txt_html[k].style.opacity = "1";


              
              if( txt_html[k].style.scale == "1" )
                txt_html[k].style.scale = "0.8";
              else
                txt_html[k].style.scale = "1";
...
function zoomImage()
{
  ...
  temp.style.transition = "all "+temp_for_time+"s";
  temp.style.transformStyle = "preserve-3d";

  image.style.transition = "all "+temp_for_time+"s";
  image.style.transformStyle = "preserve-3d";
  ...
  if( ani_style_val_2 != 'ani_envelope_rectangle_horizontal' )
  {
    ...
    card_back_before.style.transform = "rotate(75deg) scale(1.1)";
    ...
    else
    {
      if( back_card_width.split('px')[0] > 700 )
      {
        ...
        // card_before.style.transform = "translate(calc(100% - 162%), calc(100% - 155%))";
      }
      else
      {
  ...
  else
  {
    ...
    card_back_before.style.transform = "rotate(-15deg) scale(1.1)";
  }
  ...
  card_before.style.transition = "all "+temp_for_time+"s";
  card_before.style.transformStyle = "preserve-3d";
  // card_before.style.transform = "rotateX(0deg) rotate(-90deg)";
  if( back_card_width.split('px')[0] > 700 )
    card_before.style.transform = "rotateX(0deg) rotate(-90deg) scale(0.9)";
  else
    card_before.style.transform = "rotateX(0deg) rotate(-90deg) scale(0.9) scaleX(1.25)";
...
function flip_card_ani()
{
  ...
  {
    // card_back.style.transform = "rotateX(-180deg)";
    card_back.style.transform = "rotateX(0deg) rotateY(-180deg) ";
  }
  ...
  if( ani_style_val_2 != 'ani_envelope_rectangle_horizontal' )
  {
    if( back_card_width.split('px')[0] > 700 )
    {
      ...
      card_front.style.transform = "rotateX(0deg) rotate(-90deg) scale(0.9)";
...
function opennext_tab(evt, cityName) {
  ...
  {
    console.log("Envelop Is clicked");
  ...
  else if(cityName=='carte')
  {
    ...
    // jQuery('.fpd-navigation .fpd-tooltip[data-dynamic-designs-id="modifier-timbre"]').hide();
  }
...
function custom_html_card_bkp_15_10_2022(json_obj)
{
  console.log("jSONOBJECT");
  console.log(json_obj);
  // if( ani_style_val_2 == 'ani_envelope_reverse_flip' )
...
function select_type_main_bkp_20_10_2022( type )
{
  // debugger
  ani_type_acf = type;
