...
function show_funcitonalities_of_details_tab()
{
  ...
  jQuery('.fpd-pos-right').prepend('<div class="main_div_details_part" id="main_div_details_part_id" >  </div>');
  jQuery('.main_div_details_part').append('<div class="category-filter-main details_input_custom_feilds" >  </div>');
  jQuery('.fpd-actions-container').append('<div id="details_shop_address_main_div_id" class="fpd-actions-wrapper details_shop_address_main_div" >  </div>');
...
function set_music_by_types(music_type)
{
  ...
  if(music_type == "all")
  {
    ...
    if(user_unique_folderName != "")
    {
      ...
      temp_for_custom_music_show.forEach(element => {
        ...
        jQuery('.music_display_musics').append('<div class="music_link_equall music_type---'+temp_random+'" > <p > '+baseName(element)+' </p> <span class="music_play_icon" onclick="play_music('+"'"+custom_music_main_url+"/"+element+"'"+' , '+"'"+temp_random+"'"+')"> play </span> <span onclick="stop_music_clik()" class="music_stop_icon"> stop </span> </div>');  
      });
  ...
  music_display.forEach(element => {
    element["designs"].forEach(element1 => {
      temp_random=getRandomInt(500000000);
      jQuery('.music_display_musics').append('<div class="music_link_equall music_type---'+temp_random+'" > <p  > '+baseName(element1.source)+' </p> <span onclick="play_music('+"'"+element1.source+"'"+' , '+"'"+temp_random+"'"+')" class="music_play_icon"> play </span> <span onclick="stop_music_clik()" class="music_stop_icon"> stop </span> </div>');
    });
  });
...
function refresh_animation_for_userClick(my_value="")
{
 ...
 // alert(my_value);
  ...
  if (my_value == 'Hello') 
  {
    //alert("fsdvfgsdh");
    setTimeout(function(){
      jQuery('.my_custom_animation').prepend('<div id="animation_div" style="transform: rotateX(0deg);position: absolute;top: 56%; transform-style: preserve-3d;" class="my_custom_img_tag_for_animation"></div>');
      //jQuery('.my_custom_img_tag_for_animation').hide();
      
      // add envolope front side
      ...
      if (jQuery('#myonoffswitch_carte').prop('checked')==true){ 
           jQuery('.animation_envelope_front_side').prepend('<div id="animation_card_image" style="position: relative;transform-origin: center; transform: translate(154px, -95px) scaleX(1.1) scaleY(0.90);z-index: 0;transform-style: preserve-3d;transition: transform 0.6s;" ><img style="border-radius: 45px;position: absolute;transform: rotate(-90deg);transform-style: preserve-3d;transition: transform 0.6s ease 0s;" class="myy" id="img_for_animation" src="'+dataURL+'" /></div> ');
        }
        else
        {
          jQuery('.animation_envelope_front_side').prepend('<div id="animation_card_image" style="position: relative;transform-origin: center; transform: translate(154px, -95px) scaleX(1.1) scaleY(0.90);z-index: 0;transform-style: preserve-3d;transition: transform 0.6s;" ><img style="position: absolute;transform: rotate(-90deg);transform-style: preserve-3d;transition: transform 0.6s ease 0s;" class="myy" id="img_for_animation" src="'+dataURL+'" /></div> ');
        }
  ...
  {
    jQuery('.fpd-product-stage').prepend('<div id="animation_div" style="transform: rotateX(0deg);position: absolute;top: 56%; transform-style: preserve-3d;" class="my_custom_img_tag_for_animation"></div>');
      // jQuery('.my_custom_img_tag_for_animation').hide();
...
function do_animation_envelope(animation_type="fadein")
{
  ...
  if(animation_type == "fadein")
  {
    ...
    temp_for_time = (animation_time != 15) ? ((animation_time*8)/15) : 8;
  ...
  if(animation_type == "zoomin")
  {
    ...
    id = setInterval(function(){
      if(i == 310)
      {
        product_stage.style.transform = "rotateX(0deg) scale(" + (i*0.0032) + ")";
        clearInterval(id);
      }
      else
      {
  ...
  if(animation_type == "slideinleft")
  {
    ...
    id = setInterval(function(){
      ...
      {
        product_stage.style.left = ((i*(-1))/2) +"%";
        i--;
      }
    } , 8 );
  ...
  if(animation_type == "slideinup")
  {
    ...
    id = setInterval(function(){
      ...
      {
        product_stage.style.top = (-50+(i*0.257)) + "%";
        i++;
      }
    } , 8 );
  ...
  if(animation_type == "slideinright")
  {
    ...
    id = setInterval(function(){
      ...
      {
        product_stage.style.right = ((i*(-1))/2) +"%";
        i--;
      }
    } , 8 );
  ...
  temp_for_time = (animation_time != 15) ? ((3800*animation_time)/15) : 3800;
...
function flipenvelope()
{
  ...
  temp_for_time = (animation_time != 15) ? ((17*animation_time)/15) : 17;
  ...
  id = setInterval(function(){
    ...
    {
      animation_div.style.transform = "rotateY("+(parseInt(i)*4)+"deg)";
      i++;
    }
  } , temp_for_time );


  temp_for_time = (animation_time != 15) ? ((1200*animation_time)/15) : 1200;
...
function openEnvelope()
{
  ...
  temp_for_time = (animation_time != 15) ? ((14*animation_time)/15) : 14;
  ...
  id = setInterval(function(){
    ...
    else
    {
      if(i > 35)
      {
        animation_div.style.top = (30 + (parseInt(o)*0.367)) + "%";
        o++;
      }
      envelope_cap.style.transform = "rotateX("+(parseInt(i)*2)+"deg)";
...
function letterUp()
{
  ...
  let i=0;
  temp_for_time = (animation_time != 15) ? ((15*animation_time)/15) : 15;
  ...
  id = setInterval(function(){
    ...
    else
    {
      ...
      letter.style.top = (parseInt(i)*(-4)) + "px";
...
function letterrotate()
{
  ...
  // envelope_body.style.backgroundColor = "#efece4";
  ...
  id = setInterval(function(){
    ...
    {
      image.style.transform = "rotateZ("+ i +"deg)";

      // console.log("deg = "+ i );
      
      // image.style.left =  ((parseFloat(i)-89)*(-1.55))+"px";
      image.style.left =  ((parseFloat(i)-89)*(-1.2))+"px";
...
function zoomImage()
{
  ...
  let i = 0;
  temp_for_time = (animation_time != 15) ? ((10*animation_time)/15) : 10;

  image.style.transform = "rotateZ(-7.98deg)";
  ...
  id = setInterval(function(){
    ...
    {
      // image.style.transform = "rotateZ(-"+(parseFloat(i)*0.105)+"deg)";
      
      image.style.width = (440 + (parseFloat(i) )) + "px";

      full_envelope.style.transform = "rotateY(180deg) rotateZ(-"+(parseFloat(i)*0.105)+"deg)";
...
function put_whole_envelope()
{
  ...
  temp_for_time = (animation_time != 15) ? ((6*animation_time)/15) : 6;
  let i = 0;
  id = setInterval(function(){
    if(i == 101)
    {
    ...
    {
      full_envelope.style.transform = "rotateY(180deg) rotateZ(-7.98deg) scale("+(1-(i*0.001))+")";
      i++;
    }
...
function opennext_tab(evt, cityName) {
  ...
  if(cityName == 'musique')
  {
    ...
    jQuery('.fpd-main-wrapper').css({'cssText':'background-image:url("'+animation_images_location+'animation_background.png") !important;background-position: right bottom !important;'});
...
{
  var temp_count = parseInt(jQuery('#number-count_id').html());
  ...
  jQuery('#number-count_id').html( temp_count );
}
